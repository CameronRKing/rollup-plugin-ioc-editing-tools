// posthtml does not handle custom components well
// It can recognize self-closing tags, but it goes by TAG, not by specific instance.
// Either all MyCmp will be self-closing or none will.
// This is not how custom components work in Svelte.

function shouldSelfClose(node) {
    return isCustomTag(node.tag) && hasNoContent(node);
}
